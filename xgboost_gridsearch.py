...
def process_data_file(data_file_csv, base_path, prefix, roc_axes):
    ...
    # Salvar as médias e desvios padrão da acurácia
    ...
    # Curva ROC por classe (modelo multiclasse)
    plt.figure(figsize=(10, 6))
...
process_data_file(data_file, data_dir, "_xgboost", roc_axes)
...
roc_fig.savefig(f"{data_dir}/curva_roc_135_integrados_xgboost.png")
plt.close(roc_fig)
