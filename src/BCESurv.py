...
OUTPUT_DIR = "data/resultados/BCESurv"
os.makedirs(OUTPUT_DIR, exist_ok=True)

class BaseEstimatorWrapper(BaseEstimator, RegressorMixin):
    """
    Wrapper sklearn-friendly para BCESurv:
    """
    ...
    def fit(self, X, y):
        ...
        num_durations = 100
        self.labtrans = BCESurv.label_transform(num_durations)
        ...
        net = tt.practical.MLPVanilla(in_features=in_features, 
                                      ...
                                      **self.est_params)
        self.model = BCESurv(net, tt.optim.Adam, 
